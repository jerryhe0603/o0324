...
defined('PATH_ROOT')|| define('PATH_ROOT', realpath(dirname(__FILE__) . '/..')); // 根目錄
defined('PHP_SELF_PATH') || define('PHP_SELF_PATH', dirname($_SERVER['PHP_SELF'])); // php self path

define('BEAUTY2_SERVER','beauty2.lab.net');
define('GENESIS_SERVER','genesis.lab.net');
define('ORDER_SERVER', 'order.lab.net');
define('CSSCOMPANY_SERVER', 'csscompany.lab.net');


date_default_timezone_set("UTC"); // date.timezone
...
* @desc SESSION
*/
define("_SESSION_HOST", '172.16.2.69');
 ...
 */
define('_GENESIS_HOST',	'172.16.2.68');
 ...
 *  @desc 貓舍
 */
define('_OLDCAT_HOST',	'172.16.2.68');
 ...
 *  @desc 公司
 */
define('_COMPANY_HOST',	'172.16.2.68');
 ...
 *  @desc 訂單
 */
define('_ORDER_HOST',	'172.16.2.68'); 
 ...
 */
define('_GENESIS_LOG_HOST',	'172.16.2.69');
